    ...
    <div class="login-panel">
      ...
      >
        <div class="login-title">
          <img alt="logo" src="/cloud-storage.svg" />
          <span>Storage073</span>
        </div>
        <!--input输入-->
...
.login-body {
  ...
  .bg1 {
    ...
    background-size: calc(20vh);
    background-repeat: no-repeat;
    background-image: url("../assets/cat1.png");
    position: relative;
    top: 0;
    left: 0;
    animation: move1 10s infinite alternate; /* 应用动画，10秒循环一次 */
  }
  .bg2 {
    flex: 1;
    background-size: cover;
    //background-position: center 40%;
    background-size: calc(15vh);
    background-repeat: no-repeat;
    background-image: url("../assets/cat2.png");
    position: relative;
    top: 50%;
    left: 50%;
    animation: move2 8s infinite alternate; /* 应用动画，8秒循环一次 */
  }
  /* 定义第一个背景的移动路径 */
  @keyframes move1 {
    0% {
  ...
  .login-panel {
    ...
    .login-register {
      ...
      .login-title {
        ...
        gap: 15px;                    /* 控制图片和文字之间的间距 */
        color: black;
      }

      .login-title img {
        width: 40px;                  /* 设置图片宽度 */
        height: 40px;                 /* 设置图片高度，保持与宽度一致 */
      }

      .login-title span {
        margin-left: 15px;            /* 设置图片与文字之间的距离 */
      }
      .send-emali-panel {
        display: flex;
        width: 100%;
